...
private:
	...
	void pickPhysicalDevice() {
		...
		for (const auto& device : devices) {
			...
			//vkGetPhysicalDeviceMemoryProperties(candidates[score], &device_memory_property);
		}
	}
	...
	void createGraphicsPipeline() {
		...
		vertexInputInfo.vertexAttributeDescriptionCount = /*0*/attributeDescriptions.size();
	...
	void drawFrame() {
		...
		{
			throw std::runtime_error("faild to acpuire swap chain image!");
		}
